...
namespace WindowsFormsApp1.LoginDBDataSetTableAdapters {
    ...
    public partial class tblLoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblLogin] WHERE (([Username] = @Original_Username) AND ([Passw" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblLogin] SET [Username] = @Username, [Password] = @Password WHERE " +
                ...
                "CT Username, Password FROM tblLogin WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp1.Properties.Settings.Default.LoginDBConnectionString;
        }
        ...
        public virtual int Fill(LoginDBDataSet.tblLoginDataTable dataTable) {
        ...
        public virtual LoginDBDataSet.tblLoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet.tblLoginDataTable dataTable = new LoginDBDataSet.tblLoginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet.tblLoginDataTable dataTable) {
